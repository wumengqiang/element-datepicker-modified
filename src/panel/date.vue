...
<script type="text/babel">
  ...
  import HalfyearTable from '../basic/halfyear-table';
  ...
  export default {
      ...
      methods: {
          ...
          handleQuarterPick(quarter) {
              ...
              if (selectionMode === 'quarter') {
                  this.resetDate();
                  let startMonth = new Date(this.date.getFullYear(), quarter * 3, 1);
                  let endDay = (quarter === 0 || quarter === 3) ? 31 : 30;
                  let endMonth = new Date(this.date.getFullYear(), quarter * 3 + 2, endDay); // 3.31 6.30 9.30 12.31
                  this.$emit('pick', [startMonth, endMonth]);
              }
          },
      ...
      components: {
          TimePicker, YearTable, MonthTable, HalfyearTable, QuarterTable, DateTable, ElInput
      },
